  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        navy: { DEFAULT: 'oklch(0.21 0.073 249)', light: 'oklch(0.30 0.07 249)', dark: 'oklch(0.15 0.06 249)' },
        gold: { DEFAULT: 'oklch(0.70 0.12 73)', light: 'oklch(0.82 0.10 73)', dark: 'oklch(0.58 0.12 73)' },
        cream: 'oklch(0.97 0.006 75)',
      },
      borderRadius: { lg: 'var(--radius)', md: 'calc(var(--radius) - 2px)', sm: 'calc(var(--radius) - 4px)' },
      boxShadow: {
        xs: '0 1px 2px 0 rgba(0,0,0,0.05)',
        soft: '0 2px 15px -3px rgba(0,0,0,0.07), 0 10px 20px -2px rgba(0,0,0,0.04)',
        card: '0 8px 32px -4px oklch(0.21 0.073 249 / 0.14)',
        hero: '0 25px 60px -10px oklch(0.21 0.073 249 / 0.25)',
        gold: '0 4px 20px -4px oklch(0.70 0.12 73 / 0.40)',
      },
      keyframes: {
